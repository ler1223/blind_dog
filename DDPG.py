...
class DDPG:
    def __init__(self, gamma, tau, hidden_size, state_size, action_size, device="cpu", batch_size=32, count_last_states=1):
        ...
        self.actor_optimizer = torch.optim.AdamW(self.actor.parameters(), lr=1e-4)  # optimizer for the actor network
        self.critic_optimizer = torch.optim.AdamW(self.critic.parameters(), lr=1e-4)  # optimizer for the critic network
    ...
    def update_params(self):
        ...
        expected_values = torch.clamp(expected_values, -100, 100)
